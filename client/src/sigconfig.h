...
static uint32_t	field_data[VAR_MAX_REPORTS][VAR_MAX_FIELDS][VAR_REPORT_QUEUE_SIZE][MAX_FIELD_VAL_LEN];
static uint32_t	ts_s[VAR_MAX_REPORTS][VAR_REPORT_QUEUE_SIZE], ts_ms[VAR_MAX_REPORTS][VAR_REPORT_QUEUE_SIZE];
